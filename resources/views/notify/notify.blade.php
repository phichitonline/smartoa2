...
@php
    ...
    if ($data->xray_list_text || NULL) {
        $xray_list_text = $data->xray_list_text;
    } else {
        $xray_list_text = "";
    }
    if ($data->lab_list_text || NULL) {
        $lab_list_text = $data->lab_list_text;
    } else {
        $lab_list_text = "";
    }
    $labxray_text = $lab_list_text.", ".$xray_list_text;

    if ($data->lab_list_text || NULL OR $data->xray_list_text || NULL) {
