    ...
    @endforeach
					...
					<div class="content">
						...
						<div class="row">
							<div class="col-6">
								...
								<p class="mt-n2 mb-0">
									<strong class="color-theme">vn : {{ $vn }}</strong>
								</p>
							</div>
							<div class="col-6">
								<span class="font-11">เวลา</span>
								<p class="mt-n2 mb-0">
									<strong class="color-theme">oapp time</strong>
								</p>
							</div>
						</div>
		...
		<div class="card card-overflow card-style">
			<a href="{{ url('/') }}/statusq/?oappid={{ $oappid }}" class="btn btn-m btn-full rounded-s shadow-l text-center text-uppercase font-25 bg-green2-dark color-white">
				<i class="fa font-14 fa-sync-alt"></i> REFRESH ปรับปรุงข้อมูล
			</a>
		</div>
		@else
        <div class="card card-overflow card-style">
			<div class="content">
                ...
                <p class="footer-text mt-0">
                    <span class="font-16">
                        <br><b>กดปุ่ม CHECKIN เพื่อยืนยันเข้ารับบริการ และชั่งน้ำหนัก วัดส่วนสูง วัดความดัน และรอเรียกซักประวัติที่จุดบริการได้เลยค่ะ</b>
                    </span>
                </p>
		    </div>
		</div>
